...
- 🛡️ **OpenVas**: Открытый инструмент для сканирования уязвимостей.
- 🛠️ **TheHive**: Платформа для управления инцидентами и анализа угроз.
- 🛡️ **Cortex**: Инструмент для автоматизации анализа инцидентов.
- 🧑‍🎓 **TryHackMe**: Платформа для обучения кибербезопасности через практические задачи.
- 🧑‍🎓 **Hack The Box**: Платформа для обучения и практики навыков тестирования на проникновение.
